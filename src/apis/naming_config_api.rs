...
pub async fn api_v3_config_naming_examples_get(configuration: &configuration::Configuration, rename_episodes: Option<bool>, replace_illegal_characters: Option<bool>, colon_replacement_format: Option<i32>, custom_colon_replacement_format: Option<&str>, multi_episode_style: Option<i32>, standard_episode_format: Option<&str>, daily_episode_format: Option<&str>, anime_episode_format: Option<&str>, series_folder_format: Option<&str>, season_folder_format: Option<&str>, specials_folder_format: Option<&str>, id: Option<i32>, resource_name: Option<&str>) -> Result<(), Error<ApiV3ConfigNamingExamplesGetError>> {
    ...
    if let Some(ref local_var_str) = rename_episodes {
        local_var_req_builder = local_var_req_builder.query(&[("renameEpisodes", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = custom_colon_replacement_format {
        local_var_req_builder = local_var_req_builder.query(&[("customColonReplacementFormat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = multi_episode_style {
        local_var_req_builder = local_var_req_builder.query(&[("multiEpisodeStyle", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = standard_episode_format {
        local_var_req_builder = local_var_req_builder.query(&[("standardEpisodeFormat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = daily_episode_format {
        local_var_req_builder = local_var_req_builder.query(&[("dailyEpisodeFormat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = anime_episode_format {
        local_var_req_builder = local_var_req_builder.query(&[("animeEpisodeFormat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = series_folder_format {
        local_var_req_builder = local_var_req_builder.query(&[("seriesFolderFormat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = season_folder_format {
        local_var_req_builder = local_var_req_builder.query(&[("seasonFolderFormat", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = specials_folder_format {
        local_var_req_builder = local_var_req_builder.query(&[("specialsFolderFormat", &local_var_str.to_string())]);
    }
