...
pub async fn api_get(configuration: &configuration::Configuration, ) -> Result<(), Error<ApiGetError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiGetError> = serde_json::from_str(&local_var_content).ok();
