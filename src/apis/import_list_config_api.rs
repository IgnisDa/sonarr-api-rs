...
pub async fn api_v3_config_importlist_get(configuration: &configuration::Configuration, ) -> Result<models::ImportListConfigResource, Error<ApiV3ConfigImportlistGetError>> {
    ...
    let local_var_uri_str = format!("{}/api/v3/config/importlist", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV3ConfigImportlistGetError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn api_v3_config_importlist_id_get(configuration: &configuration::Configuration, id: i32) -> Result<models::ImportListConfigResource, Error<ApiV3ConfigImportlistIdGetError>> {
    ...
    let local_var_uri_str = format!("{}/api/v3/config/importlist/{id}", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV3ConfigImportlistIdGetError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn api_v3_config_importlist_id_put(configuration: &configuration::Configuration, id: &str, import_list_config_resource: Option<models::ImportListConfigResource>) -> Result<models::ImportListConfigResource, Error<ApiV3ConfigImportlistIdPutError>> {
    ...
    let local_var_uri_str = format!("{}/api/v3/config/importlist/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
    ...
    local_var_req_builder = local_var_req_builder.json(&import_list_config_resource);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ApiV3ConfigImportlistIdPutError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
